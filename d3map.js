...
// // Mainland provinces for the second map
// function drawProvinces2(error, cn) {
//     svg2.append("g")
//         .attr("class", "map")
//         .append("g")
//         .attr("class", "mainland")
...
//         .attr("class", "province")
//         .attr("fill", "#cccccc")
//         .attr("fill", function(d) { return color2(data2[d.properties.name]); })
//         .attr("stroke", "black")
//         .attr("stroke-width", "0.35");
// }

// // Taiwan for the second map
// function drawTaiwan2(error, cn) {
//     svg2.select(".map")
//         .append('g')
//         .attr("class", "taiwan")
//         .selectAll("path")
...
//         .attr("class", "province")
//         .attr("fill", "#cccccc")
//         .attr("fill", function(d) { return color2(data2["Taiwan"]); })
//         .attr("stroke", "black")
//         .attr("stroke-width", "0.35");
// }

// // HK and Macau for the second map
// function drawHkMacau2(error, cn) {
//     var projection2 = d3.geo.mercator()
//     .center([126,17])
//     .scale(2000);
...
// // DRAW the second map
// function drawMap2(error, mainland, taiwan, hkmacau) {
//     drawProvinces2(error, mainland);
//     drawTaiwan2(error, taiwan);
//     drawHkMacau2(error, hkmacau);
// }
